	export class Bullet {
	    private particles: BABYLON.Mesh[] = [];
	    private particleSystem: BABYLON.ParticleSystem;
	    private headPosition: BABYLON.Vector3;
	    private trailPositions: BABYLON.Vector3[] = [];
	    private maxTrailLength = 20;
	    private beamMaterial: BABYLON.StandardMaterial;
	    private glowLayer: BABYLON.GlowLayer;
	    constructor(scene: BABYLON.Scene, position: BABYLON.Vector3, velocity: BABYLON.Vector3) {
	        this.scene = scene;
	    ...
	    update() {
	        ...
	        this.particles.forEach((segment, i) => {
	            if (i < this.trailPositions.length - 1) {
	                ...
	                (segment.material as BABYLON.StandardMaterial).alpha = alpha * 0.7;
	            }
	        });
	    }
	    dispose() {
